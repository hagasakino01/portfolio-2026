...
export const testimonials = [
  ...
  {
    quote:
      "Reliable, proactive, and consistently delivers clean frontend solutions.",
    name: "Viet Anh",
  ...
  {
    quote:
      "Quick to understand requirements and turn ideas into polished user experiences.",
    name: "Ngoc Bich",
    role: "BA, NewGen Tech",
    initials: "NB",
  },
...
export const socialLinks = [
  ...
  { label: "Email: datyg.2402@gmail.com", href: "" },
];
