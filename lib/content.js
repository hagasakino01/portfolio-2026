...
export const projects = [
  {
    name: "Car Rent",
    description:
      "Booking-focused web platform for browsing, comparing, and managing vehicle rentals.",
  ...
  },
  {
    name: "Job IT",
    description:
      "Search-driven job experience that combines listings, salary data, and location context.",
    image: "/assets/jobit.png",
    sourceCode: "https://github.com/",
    liveDemo: "#",
    tags: [
      { name: "react", color: "text-gradient-cyan" },
      { name: "api", color: "text-gradient-emerald" },
      { name: "scss", color: "text-gradient-amber" },
    ],
  },
  {
    name: "Trip Guide",
    description:
      "Travel product with destination discovery, booking flows, and curated recommendations.",
    image: "/assets/tripguide.png",
    sourceCode: "https://github.com/",
    liveDemo: "#",
    tags: [
      { name: "nextjs", color: "text-gradient-cyan" },
      { name: "supabase", color: "text-gradient-emerald" },
      { name: "css", color: "text-gradient-amber" },
    ],
  },
];
...
export const testimonials = [
  {
    quote:
      "The final site looked polished, fast, and far more premium than our early mockups.",
    name: "Sara Lee",
    role: "CFO, Acme Co",
    initials: "SL",
  },
  ...
  {
    quote:
      "We saw better engagement after the redesign because the product finally felt intentional.",
    name: "Lisa Wang",
...
export const socialLinks = [
  ...
  { label: "Email", href: "wolfcub2402@gmail.com" },
];
